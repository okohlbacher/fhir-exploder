...
**Plans**: 2 plans
- [x] 27-01-PLAN.md — EFF-01: ResourceIssueTable pagination memo + memo-stability regression test
- [x] 27-02-PLAN.md — EFF-02 + EFF-03: 7 lazy quality routes + Suspense fallback + retry util + rollup-plugin-visualizer behind ANALYZE=1 gate
**Effort**: ~1.5 days
