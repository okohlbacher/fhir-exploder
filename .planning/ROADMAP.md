...
**Plans**: 1 plan (1 wave; sequential 7-task TDD-style execution)
**Effort**: medium (1–1.5 days — pure-JS Machado 2009 matrix + ΔE2000 port + 21-pair fixture + JSON snapshot + Phase 37 audit-chain refresh)
...
**Plans**: 3 plans (1 wave — all parallel-safe; QUAL-02 + QUAL-03 combined into 41-03 because both touch `QualityByTypeMatrix.tsx` exclusively)
...
- [x] 42-02: TBD (tab label render + dimmed-zero styling + regression tests + live-Blaze UAT)
