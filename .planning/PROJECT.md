...
---
*Last updated: 2026-05-04 — Milestone v1.8 Navigation Redesign started. STACK-01 (Mantine 9 / React 19) deferred indefinitely per user decision — removed from Active. v1.8 Active requirements set: PEEK-01..06 (JSON peek drawer), SHELL-01..04 (4-mode resource shell), EXPL-01..03 (Explorer improvements), SIDE-01..04 (Sidebar v2), LENS-01..02 (Patients-as-lens), UAT-01 (UAT backlog closure). Design handoff source: `design_handoff_v1.7_navigation/`.*
