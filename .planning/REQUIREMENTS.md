...
- [ ] **BRWS-08**: User can use _include/_revinclude to fetch related resources in a single query

### Patient-Centric Browsing

- [ ] **PTNT-01**: User can view a list of patients with search by name, identifier, and birthDate
